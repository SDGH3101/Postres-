...
<div class="app-body">
  <nav class="sidebar">
    ...
    <a href="{{ route('presupuestos.index') }}" class="sb-item {{ request()->routeIs('presupuestos.*') ? 'active':'' }}"><span>🎯</span> Presupuesto</a>
    <a href="{{ route('flujo-caja.index') }}" class="sb-item {{ request()->routeIs('flujo-caja.*') ? 'active':'' }}"><span>💵</span> Flujo de Caja</a>
    @endif
  </nav>
