    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          @if(session('usuario.id') == $u->id_usuario)
          <form method="POST" action="{{ route('usuarios.destroy', $u->id_usuario) }}" style="display:inline" onsubmit="return confirm('¿Eliminar tu propia cuenta? Esta acción no se puede deshacer.')">
            @csrf @method('DELETE')
