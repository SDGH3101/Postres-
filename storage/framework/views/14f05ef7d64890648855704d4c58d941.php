...
<div class="auth-wrap">
  ...
  <div class="auth-card">
    <div class="auth-tabs">
      <a href="<?php echo e(route('login')); ?>"    class="auth-tab on">Iniciar sesión</a>
      <a href="<?php echo e(route('register')); ?>" class="auth-tab">Crear cuenta</a>
    </div>
...
<?php /**PATH C:\xampp\htdocs\postres\resources\views/auth/login.blade.php ENDPATH**/ ?>