...
<div class="app-body">
  <nav class="sidebar">
    ...
    <a href="<?php echo e(route('presupuestos.index')); ?>" class="sb-item <?php echo e(request()->routeIs('presupuestos.*') ? 'active':''); ?>"><span>🎯</span> Presupuesto</a>
    <a href="<?php echo e(route('flujo-caja.index')); ?>" class="sb-item <?php echo e(request()->routeIs('flujo-caja.*') ? 'active':''); ?>"><span>💵</span> Flujo de Caja</a>
    <?php endif; ?>
  </nav>
