    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <?php if(session('usuario.id') == $u->id_usuario): ?>
          <form method="POST" action="<?php echo e(route('usuarios.destroy', $u->id_usuario)); ?>" style="display:inline" onsubmit="return confirm('¿Eliminar tu propia cuenta? Esta acción no se puede deshacer.')">
            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
            <button type="submit" class="btn-d">Eliminar mi cuenta</button>
          </form>
          <?php else: ?>
          <span class="badge" style="background:#eee;color:#999" title="Solo el dueño puede eliminar su cuenta">🔒 Protegida</span>
          <?php endif; ?>
        </td>
      </tr>
