...
<div class="header-box">
  <div>
    ...
    <div style="font-size:10px;color:rgba(255,255,255,.8)">Generado el <?php echo e(now()->format('d/m/Y H:i')); ?></div>
  </div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="color:#c0392b"><strong>-$<?php echo e(number_format($g->monto,0,'.','.')); ?></strong></td>
      <td>$<?php echo e(number_format($g->presupuesto,0,'.','.')); ?></td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <tr class="total-row">
      <td colspan="3" style="text-align:right">TOTAL GASTOS</td>
      <td colspan="2">-$<?php echo e(number_format($totalGastos,0,'.','.')); ?></td>
    </tr>
  </tbody>
</table>

<p style="margin-top:30px;color:#8a6a50;font-size:9px;text-align:center">
  Postres Laura © <?php echo e(now()->year); ?> · Sistema de Gestión SENA 228118 · Documento generado automáticamente
</p>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\postres\resources\views/reportes/gastos_pdf.blade.php ENDPATH**/ ?>