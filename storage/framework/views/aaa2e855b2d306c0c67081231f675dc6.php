...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="fg" style="margin-bottom:14px">
        ...
        <input type="date" name="fecha_nacimiento" value="<?php echo e(old('fecha_nacimiento')); ?>" max="<?php echo e(now()->subYears(16)->toDateString()); ?>" class="<?php echo e($errors->has('fecha_nacimiento') ? 'is-invalid':''); ?>">
